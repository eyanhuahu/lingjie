    ...
    "changelog": [
        {"日志版本": "v0.3", "日期": "2026-09-20",
         "内容":
             ...
             "蝴蝶岛：地图换成新存档的四翼布局，48×57 格、陆地 1503 格（约为原来的一半），岛上的固定实体同步精简——夜蝠巢穴 4 → 3、正常的树 2 → 1，邪恶花、尖刺灌木、针刺树、阴郁之棘等花木数量下调\n"
             "清心丸配方：格罗姆粘液 3 → 1\n"
             "入微丹配方：犀牛角 → 暗影心房\n"
             "灵韵弓：箭矢改为地面朝向，出手位置微调\n"
         ...
         "英文内容":
             ...
             "Butterfly Island: the map now uses the four-wing layout from the new world save — 48×57 tiles with 1503 land tiles (about half the land); and its fixed props were trimmed to match — Night Bat Nests 4 → 3, ordinary trees 2 → 1, with the evil flowers, spiky bushes, spiky trees and gloomy thistles cut back as well\n"
