...
SECTIONS = [
    ...
    {"分类id": "jingjie", "分类名": "境界", "短名": "境界", "排序值": "1", "是否展示": "true"},
    {"分类id": "rumo", "分类名": "生物入魔", "短名": "入魔", "排序值": "2", "是否展示": "true"},
    {"分类id": "danyao", "分类名": "丹药与炼制", "短名": "丹药", "排序值": "3", "是否展示": "true"},
    {"分类id": "cailiao", "分类名": "精炼材料", "短名": "材料", "排序值": "4", "是否展示": "true"},
    {"分类id": "jianzhu", "分类名": "建筑", "短名": "建筑", "排序值": "5", "是否展示": "true"},
    {"分类id": "wuqi", "分类名": "武器与盔甲", "短名": "武器", "排序值": "6", "是否展示": "true"},
    {"分类id": "fabao", "分类名": "法宝与工具", "短名": "法宝", "排序值": "7", "是否展示": "true"},
    {"分类id": "zhenfa", "分类名": "阵法灵技", "短名": "阵法", "排序值": "8", "是否展示": "true"},
    {"分类id": "lingzhi", "分类名": "灵植", "短名": "灵植", "排序值": "9", "是否展示": "true"},
    {"分类id": "yihuo", "分类名": "墟火与异火", "短名": "墟火", "排序值": "10", "是否展示": "true"},
    {"分类id": "ditu", "分类名": "地形与Boss", "短名": "地形", "排序值": "11", "是否展示": "true"},
    # 「人物」是占位卷目：人物还没设计完，排在最后（更新日志之前），暂无条目。
    {"分类id": "renwu", "分类名": "人物", "短名": "人物", "排序值": "12", "是否展示": "true"},
    {"分类id": "log", "分类名": "更新日志", "短名": "日志", "排序值": "99", "是否展示": "true"},
]
