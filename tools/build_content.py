...
SITE = [
    ...
    # 「网站英文名」会跟在站名后面显示（顶栏用竖线隔开），留空则整段不显示。
    {"网站标题": "灵界", "网站英文名": "Spirit Realm", "网站版本": "v0.1", "作者": "犹如黑夜星光、喵大仙BigXian"},
]
...
给予紫鳞妖焰可解锁技能「炼魂」。
插在地上会自动吸收原版的 4 种影怪，以及深度入魔产生的影体分身；每吸进一只化成一颗魔晶，直接掉在魂幡下方。
...
[[图片:images/lingjie/anim/huangjie_box_ui.png|箱子界面：上方 3×11 格，下方单独一行 1×10 格]]
