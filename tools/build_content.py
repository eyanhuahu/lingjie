...
Winter region block
Core area (swamp turf): a frozen swamp pond (where the clue boss spawns); one perfectly ordinary tree surrounded by evil flowers; three gloomy thistles; several spiky trees and spiky bushes.
...
冬季地域板块
核心区域（沼泽地皮）：有一个冰封沼泽池塘（线索 Boss 刷新处）；一棵完全正常的树，围着一些邪恶花；三棵阴郁之棘；若干针刺树，若干尖刺灌木。
    ...
    "changelog": [
        {"日志版本": "v0.3", "日期": "2026-09-20",
         "内容":
             ...
             "蝴蝶岛：地图换成新存档的四翼布局，48×57 格、陆地 1503 格（约为原来的一半），固定实体数量也随之减少（夜蝠巢穴 4 → 3、正常的树 2 → 1、邪恶花 21 → 9、尖刺灌木 40 → 16、沼泽树 17 → 9）\n"
             "清心丸配方：格罗姆粘液 3 → 1\n"
             "入微丹配方：犀牛角 → 暗影心房\n"
             "灵韵弓：箭矢改为地面朝向，出手位置微调\n"
         ...
         "英文内容":
             ...
             "Butterfly Island: the map now uses the four-wing layout from the new world save — 48×57 tiles with 1503 land tiles (about half the land); and its fixed props were trimmed accordingly (Night Bat Nests 4 → 3, ordinary trees 2 → 1, evil flowers 21 → 9, spiky bushes 40 → 16, marsh trees 17 → 9)\n"
